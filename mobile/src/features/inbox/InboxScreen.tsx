...
export function InboxScreen({ navigation, route }: Props) {
  const theme = useTheme(); const insets = useSafeAreaInsets(); const projectId = route.params.projectId; const [notes, setNotes] = useState<MobileQuickNote[]>([]);
