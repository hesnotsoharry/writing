...
Promoted: [decisions/0010-byok-routing-direct-to-anthropic-from-rust.md](decisions/0010-byok-routing-direct-to-anthropic-from-rust.md) · [decisions/0011-key-storage-keyring-crate-v4-key-stays-in-rust.md](decisions/0011-key-storage-keyring-crate-v4-key-stays-in-rust.md)
