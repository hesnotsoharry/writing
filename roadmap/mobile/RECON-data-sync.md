...
| Relationship map · viewer | Entity nodes and `entity_relations` edges/labels | View selection; add/remove links | `SqliteStoryBibleStore.listEntities/allRelations/addRelation/deleteRelation` | `characters`, `locations`, `entities`, `entity_relations` | **no** | **yes** — `MobileStoryBibleStore.addRelation/deleteRelation` |
