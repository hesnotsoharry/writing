...
|---|---|---|---|---|
| 1 | 2026-06-03 | 2026-06-03 | this commit | Gates green (lint/tsc/build exit 0); reviewer FLAG (import-order lint) dismissed — `npm run lint` exits 0. **Live `tauri dev` smoke DEFERRED to Cole** (no GUI in build session). |
