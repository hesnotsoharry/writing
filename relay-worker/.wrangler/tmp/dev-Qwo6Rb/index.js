...
var RelayRoom = class extends DurableObject {
  ...
  webSocketError(_socket, _error) {
  }
};

// src/index.ts
var ROOM_PATH = /^\/room\/([A-Za-z0-9_-]{43})$/;
...
// .wrangler/tmp/bundle-FlXRAj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FlXRAj/middleware-loader.entry.ts
