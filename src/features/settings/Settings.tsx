...
function useSettingsState(
  ...
  return { sec, setSec, tweaks, setTweak, theme, accent, toast, handleTheme, handleAccent, showToast };
}
...
function SectionRouter({ sec, tweaks, setTweak, theme, accent, onThemeChange, onAccentChange, showToast, onOpenGoals }: RouterProps) {
...
export function Settings({ onClose, setTheme, setAccent, onOpenGoals }: SettingsProps) {
  const { sec, setSec, tweaks, setTweak, theme, accent, toast, handleTheme, handleAccent, showToast } = useSettingsState(setTheme, setAccent);
      ...
      <div className="sheet set-sheet" onClick={e => e.stopPropagation()}>
        ...
        <div className="set-main">
          ...
          <div className="set-main-body">
            <SectionRouter sec={sec} tweaks={tweaks} setTweak={setTweak} theme={theme} accent={accent} onThemeChange={handleTheme} onAccentChange={handleAccent} showToast={showToast} onOpenGoals={handleGoals} />
          </div>
        </div>
      </div>
